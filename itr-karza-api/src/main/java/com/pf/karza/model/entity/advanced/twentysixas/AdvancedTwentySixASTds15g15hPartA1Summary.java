...
@Entity
@Table(name = "advanced_twenty_six_as_tds_15g_15h_part_a1_summary", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@EqualsAndHashCode(callSuper = true)
public class AdvancedTwentySixASTds15g15hPartA1Summary extends AdvancedTwentySixASTdsPartSummary {
    @ManyToOne
