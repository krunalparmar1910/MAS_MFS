...
import com.pf.karza.model.entity.ais.SftInfo.cpty.Cpty016Sb;
...
@Entity
@Table(name = "ais_data_details_sft_info_sft_016Sb", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class Sft016Sb extends BaseId {
    @ManyToOne
    @JsonBackReference
    ...
    @OneToMany(mappedBy = "sft016Sb", cascade = CascadeType.ALL)
    @JsonProperty("cpty")
    private List<Cpty016Sb> cpty016SbList;
}
