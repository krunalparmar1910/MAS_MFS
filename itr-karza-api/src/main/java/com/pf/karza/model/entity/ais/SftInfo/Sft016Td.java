...
import com.pf.karza.model.entity.ais.SftInfo.cpty.Cpty016Td;
...
@Entity
@Table(name = "ais_data_details_sft_info_sft_016Td", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class Sft016Td extends BaseId {
    @ManyToOne
    @JsonBackReference
    ...
    @OneToMany(mappedBy = "sft016Td", cascade = CascadeType.ALL)
    @JsonProperty("cpty")
    private List<Cpty016Td> cpty016Tds;
}
