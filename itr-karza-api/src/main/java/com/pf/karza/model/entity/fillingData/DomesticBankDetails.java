...
@Entity
@Table(name = "filling_data_bank_details_domestic_bank_details", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class DomesticBankDetails extends BaseId {
