...
import com.pf.karza.model.entity.ais.SftInfo.cpty.Cpty006;
...
@Entity
@Table(name = "ais_data_details_sft_info_sft_006", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class Sft006 extends BaseId {
    @ManyToOne
    @JsonBackReference
    ...
    @OneToMany(mappedBy = "sft006", cascade = CascadeType.ALL)
    @JsonProperty("cpty")
    private List<Cpty006> cpty006List;
}
