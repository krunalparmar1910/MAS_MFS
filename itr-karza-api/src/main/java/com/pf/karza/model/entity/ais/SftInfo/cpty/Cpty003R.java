...
import com.pf.karza.model.entity.ais.SftInfo.Sft003R;
...
@Entity
@Table(name = "ais_data_details_sft_info_sft_003R_cpty", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class Cpty003R extends BaseId {
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(nullable = false, name = "sft003R_id")
    @JsonBackReference
    private Sft003R sft003R;
