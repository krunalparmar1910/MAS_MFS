...
import com.pf.karza.model.entity.ais.SftInfo.cpty.Cpty003R;
...
@Entity
@Table(name = "ais_data_details_sft_info_sft_003R", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class Sft003R extends BaseId {
    @ManyToOne
    @JsonBackReference
    ...
    @OneToMany(mappedBy = "sft003R", cascade = CascadeType.ALL)
    @JsonProperty("cpty")
    private List<Cpty003R> cpty003RList;
}
