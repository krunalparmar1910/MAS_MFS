...
import com.pf.karza.model.entity.ais.SftInfo.Sft018Otu;
...
@Entity
@Table(name = "ais_data_details_sft_info_sft_018Otu_cpty", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class Cpty018Otu extends BaseId {
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(nullable = false, name = "sft018Otu_id")
    @JsonBackReference
    private Sft018Otu sft018Otu;
