...
@Entity
@Table(name = "itr_data_oth_dtls_bank_dtls_additional_domestic", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@NoArgsConstructor
@EqualsAndHashCode(callSuper = true)
public class ItrDataOthDtlsBankDtlsAdditionalDomestic extends BaseId {
    @ManyToOne
