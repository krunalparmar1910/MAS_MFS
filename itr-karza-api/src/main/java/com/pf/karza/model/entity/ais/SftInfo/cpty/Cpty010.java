...
import com.pf.karza.model.entity.ais.SftInfo.Sft010;
...
@Entity
@Table(name = "ais_data_details_sft_info_sft_010_cpty", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class Cpty010 extends BaseId {
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(nullable = false, name = "sft010_id")
    @JsonBackReference
    private Sft010 sft010;
