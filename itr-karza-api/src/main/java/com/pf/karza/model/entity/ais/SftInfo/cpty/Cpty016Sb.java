...
import com.pf.karza.model.entity.ais.SftInfo.Sft016Sb;
...
@Entity
@Table(name = "ais_data_details_sft_info_sft_016Sb_cpty", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class Cpty016Sb extends BaseId {
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(nullable = false, name = "sft016Sb_id")
    @JsonBackReference
    private Sft016Sb sft016Sb;
