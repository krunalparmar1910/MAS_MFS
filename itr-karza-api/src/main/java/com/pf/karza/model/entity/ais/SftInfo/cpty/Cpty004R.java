...
import com.pf.karza.model.entity.ais.SftInfo.Sft004R;
...
@Entity
@Table(name = "ais_data_details_sft_info_sft_004R_cpty", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class Cpty004R extends BaseId {
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(nullable = false, name = "sft004R_id")
    @JsonBackReference
    private Sft004R sft004R;
