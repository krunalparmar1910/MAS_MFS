...
import com.pf.karza.model.entity.ais.SftInfo.Sft003P;
...
@Entity
@Table(name = "ais_data_details_sft_info_sft_003P_cpty", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class Cpty003P extends BaseId {
    @ManyToOne(fetch = FetchType.LAZY)
    @JsonBackReference
    @JoinColumn(nullable = false, name = "sft003P_id")
    private Sft003P sft003P;
