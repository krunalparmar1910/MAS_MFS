...
import com.pf.karza.model.entity.ais.SftInfo.Sft017Emf;
...
@Entity
@Table(name = "ais_data_details_sft_info_sft_017Emf_cpty", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class Cpty017Emf extends BaseId {
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(nullable = false, name = "sft017Emf_id")
    @JsonBackReference
    private Sft017Emf sft017Emf;
