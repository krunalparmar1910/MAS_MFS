...
import com.pf.karza.model.entity.ais.SftInfo.cpty.Cpty004P;
...
@Entity
@Table(name = "ais_data_details_sft_info_sft_004P", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class Sft004P extends BaseId {
    @ManyToOne
    @JsonBackReference
    ...
    @OneToMany(mappedBy = "sft004P", cascade = CascadeType.ALL)
    @JsonProperty("cpty")
    private List<Cpty004P> cpty004PList;
}
