...
import com.pf.karza.model.entity.ais.SftInfo.cpty.Cpty012S;
...
@Entity
@Table(name = "ais_data_details_sft_info_sft_012S", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class Sft012S extends BaseId {
    @ManyToOne
    @JsonBackReference
    ...
    @OneToMany(mappedBy = "sft012S", cascade = CascadeType.ALL)
    @JsonProperty("cpty")
    private List<Cpty012S> cpty012SList;
}
