...
@Entity
@Table(name = "advanced_twenty_six_as_tds_immv_seller_deductor_wise_record", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@EqualsAndHashCode(callSuper = true)
public class AdvancedTwentySixASTDSImmvSellerDeductorWiseRecord extends BaseId {
    @ManyToOne
