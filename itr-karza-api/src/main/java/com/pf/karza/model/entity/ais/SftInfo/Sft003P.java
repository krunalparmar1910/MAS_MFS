...
import com.pf.karza.model.entity.ais.SftInfo.cpty.Cpty003P;
...
@Entity
@Table(name = "ais_data_details_sft_info_sft_003P", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class Sft003P extends BaseId {
    @ManyToOne
    @JsonBackReference
    ...
    @OneToMany(mappedBy = "sft003P", cascade = CascadeType.ALL)
    @JsonProperty("cpty")
    private List<Cpty003P> cpty003PList;
}
