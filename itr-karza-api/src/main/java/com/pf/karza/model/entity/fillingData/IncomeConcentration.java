...
@Entity
@Table(name = "filling_data_financial_info_income_details_income_concentration", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class IncomeConcentration extends BaseId {
