...
@Entity
@Table(name = "itr_data_fin_info_pl_summ_exp", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@EqualsAndHashCode(callSuper = true)
public class ItrDataFinInfoPlSummExp extends BaseId {
    @OneToOne
    ...
    private BigDecimal chngsInInvnt;

    private BigDecimal employeeBenefitExpense;

    private BigDecimal financeCosts;

    private BigDecimal deprDepltnAmrtstn;

    private BigDecimal expExplrtnPrdtnActvts;
