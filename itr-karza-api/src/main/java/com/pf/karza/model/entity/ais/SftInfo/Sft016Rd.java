...
import com.pf.karza.model.entity.ais.SftInfo.cpty.Cpty016Rd;
...
@Entity
@Table(name = "ais_data_details_sft_info_sft_016Rd", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class Sft016Rd extends BaseId {
    @ManyToOne
    @JsonBackReference
    ...
    @OneToMany(mappedBy = "sft016Rd", cascade = CascadeType.ALL)
    @JsonProperty("cpty")
    private List<Cpty016Rd> cpty016RdList;
}
