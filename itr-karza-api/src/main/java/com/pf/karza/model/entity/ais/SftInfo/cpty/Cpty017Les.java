...
import com.pf.karza.model.entity.ais.SftInfo.Sft017Les;
...
@Entity
@Table(name = "ais_data_details_sft_info_sft_017Les_cpty", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class Cpty017Les extends BaseId {
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(nullable = false, name = "sft017Les_id")
    @JsonBackReference
    private Sft017Les sft017Les;
