...
@Entity
@Table(name = "itr_data_analysis_inc_dtls_income_concentration", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@EqualsAndHashCode(callSuper = true)
public class ItrDataAnalysisIncDtlsIncomeConcentration extends BaseId {
    @OneToOne
