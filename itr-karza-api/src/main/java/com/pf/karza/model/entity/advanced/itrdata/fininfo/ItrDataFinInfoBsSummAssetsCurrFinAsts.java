...
@Entity
@Table(name = "itr_data_fin_info_bs_summ_assets_curr_fin_asts", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@EqualsAndHashCode(callSuper = true)
public class ItrDataFinInfoBsSummAssetsCurrFinAsts extends BaseId {
    @OneToOne
    @JoinColumn(nullable = false, name = "itr_data_fin_info_bs_summ_assets_curr_asts_id")
    @JsonBackReference
