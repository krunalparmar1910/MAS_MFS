...
import com.pf.karza.model.entity.ais.SftInfo.Sft017Otu;
...
@Entity
@Table(name = "ais_data_details_sft_info_sft_017Otu_cpty", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class Cpty017Otu extends BaseId {
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(nullable = false, name = "sft017Otu_id")
    @JsonBackReference
    private Sft017Otu sft017Otu;
