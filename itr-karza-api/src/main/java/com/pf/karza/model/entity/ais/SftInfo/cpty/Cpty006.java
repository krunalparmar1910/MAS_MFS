...
import com.pf.karza.model.entity.ais.SftInfo.Sft006;
...
@Entity
@Table(name = "ais_data_details_sft_info_sft_006_cpty", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class Cpty006 extends BaseId {
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(nullable = false, name = "sft006_id")
    @JsonBackReference
    private Sft006 sft006;
