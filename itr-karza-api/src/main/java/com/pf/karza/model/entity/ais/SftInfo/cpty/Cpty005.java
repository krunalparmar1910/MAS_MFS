...
import com.pf.karza.model.entity.ais.SftInfo.Sft005;
...
@Entity
@Table(name = "ais_data_details_sft_info_sft_005_cpty", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class Cpty005 extends BaseId {
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(nullable = false, name = "sft005_id")
    @JsonBackReference
    private Sft005 sft005;
