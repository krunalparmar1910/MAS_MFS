...
@Entity
@Table(name = "itr_data_fin_info_bs_summ_equity_att_to_owners_of_parent", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@EqualsAndHashCode(callSuper = true)
public class ItrDataFinInfoBsSummEquityAttrToOwnersOfParent extends BaseId {
    @OneToOne
    @JoinColumn(nullable = false, name = "itr_data_fin_info_bs_summ_equity_id")
    @JsonBackReference
