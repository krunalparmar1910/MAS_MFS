...
import com.pf.karza.model.entity.ais.SftInfo.cpty.Cpty010;
...
@Entity
@Table(name = "ais_data_details_sft_info_sft_010", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class Sft010 extends BaseId {
    @ManyToOne
    @JsonBackReference
    ...
    @OneToMany(mappedBy = "sft010", cascade = CascadeType.ALL)
    @JsonProperty("cpty")
    private List<Cpty010> cpty010List;
}
