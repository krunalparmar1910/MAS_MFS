...
import com.pf.karza.model.entity.ais.SftInfo.cpty.Cpty018Pur;
...
@Entity
@Table(name = "ais_data_details_sft_info_sft_018Pur", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class Sft018Pur extends BaseId {
    @ManyToOne
    @JsonBackReference
    ...
    @OneToMany(mappedBy = "sft018Pur", cascade = CascadeType.ALL)
    @JsonProperty("cpty")
    private List<Cpty018Pur> cpty018PurList;
}
