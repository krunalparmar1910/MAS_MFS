...
import com.pf.karza.model.entity.ais.SftInfo.cpty.Cpty004R;
...
@Entity
@Table(name = "ais_data_details_sft_info_sft_004R", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class Sft004R extends BaseId {
    @ManyToOne
    @JsonBackReference
    ...
    @OneToMany(mappedBy = "sft004R", cascade = CascadeType.ALL)
    @JsonProperty("cpty")
    private List<Cpty004R> cpty004RList;
}
