...
import com.pf.karza.model.entity.ais.SftInfo.cpty.Cpty017Les;
...
@Entity
@Table(name = "ais_data_details_sft_info_sft_017Les", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class Sft017Les extends BaseId {
    @ManyToOne
    @JsonBackReference
    ...
    @OneToMany(mappedBy = "sft017Les", cascade = CascadeType.ALL)
    @JsonProperty("cpty")
    private List<Cpty017Les> cpty017LesList;
}
