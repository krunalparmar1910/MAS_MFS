...
import com.pf.karza.model.entity.ais.SftInfo.cpty.Cpty018Emf;
...
@Entity
@Table(name = "ais_data_details_sft_info_sft_018Emf", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class Sft018Emf extends BaseId {
    @ManyToOne
    @JsonBackReference
    ...
    @OneToMany(mappedBy = "sft018Emf", cascade = CascadeType.ALL)
    @JsonProperty("cpty")
    private List<Cpty018Emf> cpty018EmfList;
}
