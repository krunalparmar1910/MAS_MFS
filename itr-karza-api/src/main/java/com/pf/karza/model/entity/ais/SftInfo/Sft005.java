...
import com.pf.karza.model.entity.ais.SftInfo.cpty.Cpty005;
...
@Entity
@Table(name = "ais_data_details_sft_info_sft_005", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class Sft005 extends BaseId {
    @ManyToOne
    @JsonBackReference
    ...
    @OneToMany(mappedBy = "sft005", cascade = CascadeType.ALL)
    @JsonProperty("cpty")
    private List<Cpty005> cpty005List;
}
