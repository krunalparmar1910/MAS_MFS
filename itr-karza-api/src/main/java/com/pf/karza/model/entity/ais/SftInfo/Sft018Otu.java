...
import com.pf.karza.model.entity.ais.SftInfo.cpty.Cpty018Otu;
...
@Entity
@Table(name = "ais_data_details_sft_info_sft_0180tu", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class Sft018Otu extends BaseId {
    @ManyToOne
    @JsonBackReference
    ...
    @OneToMany(mappedBy = "sft018Otu", cascade = CascadeType.ALL)
    @JsonProperty("cpty")
    private List<Cpty018Otu> cpty018OtuList;
}
