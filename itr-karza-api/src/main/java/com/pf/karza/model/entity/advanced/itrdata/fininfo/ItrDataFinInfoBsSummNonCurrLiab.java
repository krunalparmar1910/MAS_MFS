...
@Entity
@Table(name = "itr_data_fin_info_bs_summ_non_curr_liab", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@EqualsAndHashCode(callSuper = true)
public class ItrDataFinInfoBsSummNonCurrLiab extends BaseId {
    @OneToOne
    ...
    @JsonProperty("nonCurrFinLiab")
    @JsonManagedReference
    @OneToOne(mappedBy = "itrDataFinInfoBsSummNonCurrLiab", orphanRemoval = true, cascade = CascadeType.ALL)
    private ItrDataFinInfoBsSummNonCurrFinLiab itrDataFinInfoBsSummNonCurrFinLiab;
