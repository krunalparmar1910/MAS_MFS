...
import com.pf.karza.model.entity.ais.SftInfo.cpty.Cpty017Pur;
...
@Entity
@Table(name = "ais_data_details_sft_info_sft_017Pur", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class Sft017Pur extends BaseId {
    @ManyToOne
    @JsonBackReference
    ...
    @OneToMany(mappedBy = "sft017Pur", cascade = CascadeType.ALL)
    @JsonProperty("cpty")
    private List<Cpty017Pur> cpty017PurList;
}
