...
import com.pf.karza.model.entity.ais.SftInfo.Sft016Rd;
...
@Entity
@Table(name = "ais_data_details_sft_info_sft_016Rd_cpty", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class Cpty016Rd extends BaseId {
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(nullable = false, name = "sft016Rd_id")
    @JsonBackReference
    private Sft016Rd sft016Rd;
