...
import com.pf.karza.model.entity.ais.SftInfo.cpty.Cpty017Emf;
...
@Entity
@Table(name = "ais_data_details_sft_info_sft_017Emf", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class Sft017Emf extends BaseId {
    @ManyToOne
    @JsonBackReference
    ...
    @OneToMany(mappedBy = "sft017Emf", cascade = CascadeType.ALL)
    @JsonProperty("cpty")
    private List<Cpty017Emf> cpty017EmfList;
}
