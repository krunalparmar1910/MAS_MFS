...
import com.pf.karza.model.entity.ais.SftInfo.cpty.Cpty017Otu;
...
@Entity
@Table(name = "ais_data_details_sft_info_sft_0170tu", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class Sft017Otu extends BaseId {
    @ManyToOne
    @JsonBackReference
    ...
    @OneToMany(mappedBy = "sft017Otu", cascade = CascadeType.ALL)
    @JsonProperty("cpty")
    private List<Cpty017Otu> cpty017OtuList;
}
