...
import com.pf.karza.model.entity.ais.SftInfo.cpty.Cpty012P;
...
@Entity
@Table(name = "ais_data_details_sft_info_sft_012P", schema = DbConstants.ITR_SCHEMA_NAME)
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class Sft012P extends BaseId {
    @ManyToOne
    @JsonBackReference
    ...
    @OneToMany(mappedBy = "sft012P", cascade = CascadeType.ALL)
    @JsonProperty("cpty")
    private List<Cpty012P> cpty012PList;
}
